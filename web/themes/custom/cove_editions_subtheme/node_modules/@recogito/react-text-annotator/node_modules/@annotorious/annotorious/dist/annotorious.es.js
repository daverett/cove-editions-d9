...
const No = {
  ...
  return ge(t);
}, Te = (e) => e.rings.map((n) => Co(n.points)).join(" "), Ro = (e) => e.polygons.reduce((t, n) => [
  ...t,
...
const di = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), nn = { randomUUID: di };
function hi(e, t, n) {
  var o;
  e = e || {};
...
}, pi = (e, t) => t.bodies.map((n) => {
  const o = e.bodies.find((i) => i.id === n.id);
  return { newBody: n, oldBody: o && !Ce(o, n) ? o : void 0 };
}).filter(({ oldBody: n }) => n).map(({ oldBody: n, newBody: o }) => ({ oldBody: n, newBody: o })), _i = (e, t) => !Ce(e.target, t.target), so = (e, t) => {
...
}, Nr = (e, t, n) => typeof t == "function" ? t(e, n) : t, Rr = (e, t) => typeof e != "function" && typeof t != "function" ? {
  ...e || {},
  ...t || {}
} : (n, o) => {
...
}, Di = (e, t = 21) => Oi(e, t | 0, Ci), Ni = (e = 21) => {
  let t = "", n = crypto.getRandomValues(new Uint8Array(e |= 0));
  for (; e--; )
    t += Ii[n[e] & 63];
  return t;
};
const Ri = () => ({ isGuest: !0, id: Di("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_", 20)() }), Yi = (e) => {
  ...
  return `${n}`;
}, ro = (e) => e ? typeof e == "object" ? { ...e } : e : void 0, Bi = (e, t) => (Array.isArray(e) ? e : [e]).map((n) => {
...
Ni();
const Br = (e, t = { strict: !0, invertY: !1 }) => ({ parse: (i) => Xi(i, t), serialize: (i) => Hi(i, e, t) }), Xi = (e, t = { strict: !0, invertY: !1 }) => {
  const n = e.id || no(), {
    creator: o,
    created: i,
    modified: s,
...
navigator.msMaxTouchPoints > 0, Fi = (e) => ({}), on = (e) => ({ grab: (
  /*onGrab*/
  e[0]
) });
function qi(e) {
  ...
  return {
    ...
    m(w, v) {
      ...
      for (let _ = 0; _ < R.length; _ += 1)
        R[_] && R[_].m(w, v);
      N(w, E, v), z && z.m(w, v), N(w, S, v), y = !0, A || (M = [
        W(
          f,
          "pointerup",
          /*onShapePointerUp*/
    ...
    d(w) {
      w && (D(t), D(d), D(f), D(p), D(m), D(k), D(E), D(S)), C && C.d(), T && T.d(), Ne(R, w), z && z.d(w), A = !1, Se(M);
    }
  };
}
function os(e) {
...
const is = 250, ss = 1e3, rs = 12, $e = 4.5, fn = (e) => e.join(","), dn = (e) => e.join(","), hn = (e) => e.join(",");
function ls(e, t, n) {
  let o, i, s;
  const r = Oe();
...
function cs(e) {
  ...
  return $ = new Fe({
    ...
    m(F, Y) {
      N(F, t, Y), j(t, n), j(n, o), j(n, a), N(F, p, Y), N(F, m, Y), N(F, y, Y), N(F, A, Y), N(F, R, Y), N(F, q, Y), N(F, _, Y), N(F, b, Y), N(F, G, Y), N(F, X, Y), N(F, te, Y), N(F, oe, Y), N(F, ce, Y), re($, F, Y), N(F, fe, Y), re(_e, F, Y), N(F, Be, Y), re(Pe, F, Y), N(F, wt, Y), re(Ie, F, Y), Q = !0, bt || (Wt = [
        W(m, "pointerdown", function() {
          ie(
            /*grab*/
            e[12]("SHAPE")
    ...
    i(F) {
      Q || (B($.$$.fragment, F), B(_e.$$.fragment, F), B(Pe.$$.fragment, F), B(Ie.$$.fragment, F), Q = !0);
    },
    o(F) {
      H($.$$.fragment, F), H(_e.$$.fragment, F), H(Pe.$$.fragment, F), H(Ie.$$.fragment, F), Q = !1;
    },
    d(F) {
      F && (D(t), D(p), D(m), D(y), D(A), D(R), D(q), D(_), D(b), D(G), D(X), D(te), D(oe), D(ce), D(fe), D(Be), D(wt)), le($, F), le(_e, F), le(Pe, F), le(Ie, F), bt = !1, Se(Wt);
    }
  };
}
function us(e) {
...
function vn(e) {
  ...
  return {
    ...
    d(T) {
      T && D(t), S && S.d(), y && y.d(), Ne(M, T), k = !1, Se(E);
    }
  };
}
function Sn(e) {
...
const ao = /* @__PURE__ */ new Map([
  ...
  [x.POLYGON, as],
  [x.MULTIPOLYGON, bs]
]), Es = (e) => ao.get(e.type), vs = (e, t) => ao.set(e, t);
function Ss(e, t, n) {
  let o;
  const i = Oe();
...
const Kt = /* @__PURE__ */ new Map([
  ["rectangle", { tool: Ps }],
  ["polygon", { tool: Ns }]
]), co = () => [...Kt.keys()], uo = (e) => Kt.get(e), Rs = (e, t, n = {}) => Kt.set(e, { tool: t, opts: n });
function Ys(e) {
  let t, n, o, i, s;
  return {
    c() {
...
function hr(e) {
  ...
  return {
    ...
    d(f) {
      f && D(t), Ne(a, f), d && d.d(), e[35](null), e[36](null), s = !1, Se(r);
    }
  };
}
function gr(e, t, n) {
  ...
  e.$$.on_destroy.push(() => g());
  let { drawingEnabled: E } = t, { image: S } = t, { preferredDrawingMode: y } = t, { state: A } = t, { style: M = void 0 } = t, { toolName: C = co()[0] } = t, { user: T } = t, { visible: U = !0 } = t, R = 0;
...
class _r {
  ...
  remove(t, n) {
    ...
    for (; o || s.length; ) {
      ...
      !u && !o.leaf && Bt(o, i) ? (s.push(o), r.push(l), l = 0, a = o, o = o.children[0]) : a ? (l++, o = a.children[l], u = !1) : o = null;
    }
    return this;
  }
  toBBox(t) {
...
}, Vn = (e, t, n) => t.setAttribute("data-theme", n === "auto" ? Tr(e) : n), Lr = (e, t) => ({
  ...e,
...
}), Xn = typeof navigator > "u" ? !1 : navigator.userAgent.indexOf("Mac OS X") !== -1, Pr = (e, t) => {

...
function jn(e, t, n, o) {
  return e[1] && o ? Bt(n.ctx.slice(), e[1](o(t))) : n.ctx;
}
function yo(e, t, n, o) {
  if (e[2] && o) {
    const i = e[2](o(n));
...
function vo(e, t, { bubbles: n = !1, cancelable: o = !1 } = {}) {
...
function Zn() {
  ...
  do {
    ...
    for (Qe(null), Ge.length = 0, Be = 0; ht.length; ) ht.pop()();
...
function me(e, t, n, o, i, s, r = null, l = [-1]) {
  ...
  if (u.ctx = n ? n(e, t.props || {}, (f, h, ...p) => {
    ...
    t.intro && U(e.$$.fragment), re(e, t.target, t.anchor), Zn();
  }
  Qe(a);
}
class pe {
...
var Lo = Jn.exports;
const Po = /* @__PURE__ */ To(Lo), zt = {}, Ke = (e, t) => zt[e] = t, Ht = (e) => zt[e.type].area(e), Io = (e, t, n, o) => zt[e.type].intersects(e, t, n, o), ge = (e) => {
...
const Ro = {
  ...
  return ge(t);
}, Te = (e) => e.rings.map((n) => Co(n.points)).join(" "), No = (e) => e.polygons.reduce((t, n) => [
  ...t,
  ...
  for (let o = 0; o < e.points.length - 1; o++) {
    ...
    if (i.type === "CURVE" || s.type === "CURVE") {
      ...
      for (let a = 0; a < l.length - 1; a++)
        if (xt(t, l[a], l[a + 1]) <= n) return !0;
    } else if (xt(t, i.point, s.point) <= n) return !0;
  }
  return !1;
}, xt = (e, t, n) => {
...
}, eo = "http://www.w3.org/2000/svg", $t = (e) => {
  const t = (o) => {
...
}, xo = (e) => `<g>${e.polygons.map((n) => `<path fill-rule="evenodd" d="${Te(n)}" />`).join("")}</g>`, $o = (e) => {
  let t;
  switch (e.type) {
    case x.POLYGON: {
...
const oi = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), en = { randomUUID: oi };
function no(e, t, n) {
  var i;
  if (en.randomUUID && !e)
...
function Ce(e, t) {
  ...
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (!n || typeof e == "object") {
      o = 0;
      for (n in e)
        if (tn.call(e, n) && ++o && !tn.call(t, n) || !(n in t) || !Ce(e[n], t[n])) return !1;
...
var oo = /* @__PURE__ */ ((e) => (e.EDIT = "EDIT", e.SELECT = "SELECT", e.NONE = "NONE", e))(oo || {});
const st = { selected: [] }, ri = (e, t, n) => {
  ...
  const l = () => {
    ...
    const S = E.reduce((y, A) => {
      const M = m(A);
      return M === "EDIT" ? [...y, { id: A.id, editable: !0 }] : M === "SELECT" ? [...y, { id: A.id }] : y;
    }, []);
...
const fi = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), nn = { randomUUID: fi };
function io(e, t, n) {
  var o;
  if (nn.randomUUID && !e)
    return nn.randomUUID();
  e = e || {};
  const i = e.random ?? ((o = e.rng) == null ? void 0 : o.call(e)) ?? ui();
  if (i.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return i[6] = i[6] & 15 | 64, i[8] = i[8] & 63 | 128, ai(i);
}
const Tt = (e) => {
  const t = (n) => {
    const o = { ...n };
...
}, gi = (e, t) => t.bodies.map((n) => {
  const o = e.bodies.find((i) => i.id === n.id);
  return { newBody: n, oldBody: o && !Ce(o, n) ? o : void 0 };
}).filter(({ oldBody: n }) => n).map(({ oldBody: n, newBody: o }) => ({ oldBody: n, newBody: o })), mi = (e, t) => !Ce(e.target, t.target), so = (e, t) => {
  const n = di(e, t), o = hi(e, t), i = gi(e, t);
  return {
    oldValue: e,
    newValue: t,
...
const pi = (e, t) => {
  ...
  const e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), n = [], o = (w, v = {}) => {
    ...
    const _ = w.map((b) => B({ id: b.id, annotation: b.annotation }, b)).filter(Boolean);
    s(v, { updated: _ });
  }, z = (w) => {
    const v = e.get(w.annotation);
    if (v) {
...
const vi = 250, Si = (e, t) => {
  const n = Ei(), o = (t == null ? void 0 : t.changes) || [];
  ...
  const a = (m) => m && m.length > 0 && e.bulkDeleteAnnotations(m), u = (m) => m && m.length > 0 && e.bulkAddAnnotations(m, !1), d = (m) => m && m.length > 0 && e.bulkUpdateAnnotations(m.map(({ oldValue: g }) => g)), f = (m) => m && m.length > 0 && e.bulkUpdateAnnotations(m.map(({ newValue: g }) => g)), h = (m) => m && m.length > 0 && e.bulkAddAnnotations(m, !1), p = (m) => m && m.length > 0 && e.bulkDeleteAnnotations(m);
  return {
  ...
  return t.on("undo", k(!0)), t.on("redo", k(!1)), { on: h, off: p, emit: m };
}, Mi = (e) => (t) => t.reduce((n, o) => {
  ...
  const { store: o, selection: i } = e, s = (E) => {
  ...
  }, f = (E, S = !0) => fetch(E).then((y) => y.json()).then((y) => (p(y, S), y)), h = (E) => {
    if (typeof E == "string") {
      const S = o.getAnnotation(E);
    ...
    if (n) {
      const y = n.parseAll || Mi(n), { parsed: A, failed: M } = y(E);
    ...
    i.clear(), i.setUserSelectAction(E);
  }, k = (E) => {
    if (n) {
...
}, Or = (e, t, n) => typeof t == "function" ? t(e, n) : t, Dr = (e, t) => typeof e != "function" && typeof t != "function" ? {
  ...e || {},
  ...t || {}
} : (n, o) => {
...
let Pi = (e) => crypto.getRandomValues(new Uint8Array(e)), Ii = (e, t, n) => {
...
}, Ci = (e, t = 21) => Ii(e, t | 0, Pi), Oi = (e = 21) => {
  let t = "", n = crypto.getRandomValues(new Uint8Array(e |= 0));
  for (; e--; )
    t += Li[n[e] & 63];
  return t;
};
const Di = () => ({ isGuest: !0, id: Ci("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_", 20)() }), Ri = (e) => {
  ...
  return `${n}`;
}, ro = (e) => e ? typeof e == "object" ? { ...e } : e : void 0, Ni = (e, t) => (Array.isArray(e) ? e : [e]).map((n) => {
...
Oi();
const Nr = (e, t = { strict: !0, invertY: !1 }) => ({ parse: (i) => Bi(i, t), serialize: (i) => Vi(i, e, t) }), Bi = (e, t = { strict: !0, invertY: !1 }) => {
  const n = e.id || no(), {
    creator: o,
    created: i,
    modified: s,
    body: r,
    ...l
  } = e, a = Ni(r || [], n), u = Array.isArray(e.target) ? e.target[0] : e.target, d = typeof u == "string" ? u : Array.isArray(u.selector) ? u.selector[0] : u.selector, f = typeof d == "string" || (d == null ? void 0 : d.type) === "FragmentSelector" ? Xo(d, t.invertY) : (d == null ? void 0 : d.type) === "SvgSelector" ? Qo(d) : void 0, h = Array.isArray(l.target) ? l.target[0] : l.targret;
  return f || !t.strict ? {
    parsed: {
      ...l,
      id: n,
...
navigator.msMaxTouchPoints > 0, ji = (e) => ({}), on = (e) => ({ grab: (
  /*onGrab*/
  e[0]
) });
function zi(e) {
...
function qi(e) {
  ...
  return {
    ...
    m(d, f) {
      R(d, t, f), j(t, n), u && u.m(t, null), j(t, i), l || (a = [
        W(
          n,
          "dblclick",
          /*dblclick_handler_1*/
...
function Zi(e, t, n) {
  ...
  return e.$$set = (y) => {
    n(8, t = Bt(Bt({}, t), Jt(y))), "x" in y && n(0, i = y.x), "y" in y && n(1, s = y.y), "scale" in y && n(2, r = y.scale), "selected" in y && n(3, l = y.selected);
  }, e.$$.update = () => {
    e.$$.dirty & /*scale*/
    4 && n(5, o = 4 / r);
  }, t = Jt(t), [
...
class Fe extends pe {
  constructor(t) {
    super(), me(this, t, Zi, Wi, se, { x: 0, y: 1, scale: 2, selected: 3 });
  }
}
function Ji(e) {
  let t, n, o, i, s, r, l;
...
class lo extends pe {
  constructor(t) {
    super(), me(this, t, $i, xi, se, { x: 0, y: 1, scale: 4 });
  }
}
function Lt(e) {
  const t = e.slice(), n = (
...
function es(e) {
  ...
  return {
    ...
    m(w, v) {
      R(w, t, v), j(t, n), j(n, o), j(n, a), C && C.m(n, null), T && T.m(t, null), R(w, d, v), R(w, f, v), R(w, p, v), R(w, m, v), R(w, k, v);
      for (let _ = 0; _ < N.length; _ += 1)
        N[_] && N[_].m(w, v);
      R(w, E, v), z && z.m(w, v), R(w, S, v), y = !0, A || (M = [
        W(
          f,
          "pointerup",
          /*onShapePointerUp*/
    ...
    p(w, v) {
      ...
      134322472) {
        ...
        for (_ = 0; _ < B.length; _ += 1) {
          const b = rn(e, B, _);
          N[_] ? (N[_].p(b, v), U(N[_], 1)) : (N[_] = cn(b), N[_].c(), U(N[_], 1), N[_].m(E.parentNode, E));
        }
        for (we(), _ = B.length; _ < N.length; _ += 1)
          q(_);
        be();
      }
      /*visibleMidpoint*/
      ...
      192 && U(z, 1)) : (z = un(Lt(e)), z.c(), U(z, 1), z.m(S.parentNode, S)) : z && (we(), H(z, 1, 1, () => {
        z = null;
      }), be());
    },
    i(w) {
    ...
    d(w) {
      w && (D(t), D(d), D(f), D(p), D(m), D(k), D(E), D(S)), C && C.d(), T && T.d(), Re(N, w), z && z.d(w), A = !1, Se(M);
    }
  };
}
function ts(e) {
...
const ns = 250, os = 1e3, is = 12, $e = 4.5, fn = (e) => e.join(","), dn = (e) => e.join(","), hn = (e) => e.join(",");
function ss(e, t, n) {
  let o, i, s;
  const r = Oe();
  let { shape: l } = t, { computedStyle: a } = t, { transform: u } = t, { viewportScale: d = 1 } = t, { svgEl: f } = t, h, p = !1, m, g = [];
  const k = () => n(7, p = !0), E = () => n(7, p = !1), S = (_) => {
    if (g.length > 0 || !i.some((K) => K.visible)) {
      n(6, h = void 0);
      return;
    }
    const [b, I] = u.elementToImage(_.offsetX, _.offsetY), L = (K) => Math.pow(K[0] - b, 2) + Math.pow(K[1] - I, 2), O = o.points.reduce((K, J) => L(J) < L(K) ? J : K), G = i.filter((K) => K.visible).reduce((K, J) => L(J.point) < L(K.point) ? J : K), X = Math.pow(os / d, 2);
    ...
    n(7, p = !0), _.preventDefault(), _.stopPropagation(), m = performance.now();
  }, C = (_) => (b) => {
    if (!m || Le || performance.now() - m > ns) return;
  ...
  return e.$$set = (_) => {
    ...
    40 && n(10, i = Le ? [] : o.points.map((_, b) => {
      const I = b === o.points.length - 1 ? o.points[0] : o.points[b + 1], L = (_[0] + I[0]) / 2, O = (_[1] + I[1]) / 2, X = Math.sqrt(Math.pow(I[0] - L, 2) + Math.pow(I[1] - O, 2)) > is / d;
...
function ls(e) {
  let t, n, o, i, s, r, l, a, u, d, f, h, p, m, g, k, E, S, y, A, M, C, T, B, N, q, z, w, v, _, b, I, L, O, G, X, Z, K, J, te, oe, Ee, ke, V, ce, $, fe, _e, Ue, Pe, wt, Ie, Q, bt, Wt;
  return $ = new Fe({
    props: {
    ...
    c() {
      t = P("defs"), n = P("mask"), o = P("rect"), a = P("rect"), p = ye(), m = P("rect"), y = ye(), A = P("rect"), N = ye(), q = P("rect"), _ = ye(), b = P("rect"), G = ye(), X = P("rect"), te = ye(), oe = P("rect"), ce = ye(), ae($.$$.fragment), fe = ye(), ae(_e.$$.fragment), Ue = ye(), ae(Pe.$$.fragment), wt = ye(), ae(Ie.$$.fragment), c(o, "class", "rect-mask-bg svelte-1njczvj"), c(o, "x", i = /*mask*/
      e[6].x), c(o, "y", s = /*mask*/
    ...
    m(F, Y) {
      R(F, t, Y), j(t, n), j(n, o), j(n, a), R(F, p, Y), R(F, m, Y), R(F, y, Y), R(F, A, Y), R(F, N, Y), R(F, q, Y), R(F, _, Y), R(F, b, Y), R(F, G, Y), R(F, X, Y), R(F, te, Y), R(F, oe, Y), R(F, ce, Y), re($, F, Y), R(F, fe, Y), re(_e, F, Y), R(F, Ue, Y), re(Pe, F, Y), R(F, wt, Y), re(Ie, F, Y), Q = !0, bt || (Wt = [
        W(m, "pointerdown", function() {
          ie(
            /*grab*/
            e[12]("SHAPE")
    ...
    i(F) {
      Q || (U($.$$.fragment, F), U(_e.$$.fragment, F), U(Pe.$$.fragment, F), U(Ie.$$.fragment, F), Q = !0);
    },
    o(F) {
      H($.$$.fragment, F), H(_e.$$.fragment, F), H(Pe.$$.fragment, F), H(Ie.$$.fragment, F), Q = !1;
    },
    d(F) {
      F && (D(t), D(p), D(m), D(y), D(A), D(N), D(q), D(_), D(b), D(G), D(X), D(te), D(oe), D(ce), D(fe), D(Ue), D(wt)), le($, F), le(_e, F), le(Pe, F), le(Ie, F), bt = !1, Se(Wt);
    }
  };
}
function as(e) {
...
function cs(e, t, n) {
  ...
  const d = (g, k, E) => {
    ...
    const N = Math.min(y, M), q = Math.min(A, C), z = Math.abs(M - y), w = Math.abs(C - A);
    return {
      ...g,
      geometry: {
        x: N,
...
function jt(e, t) {
  ...
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (!n || typeof e == "object") {
      o = 0;
      for (n in e)
        if (gn.call(e, n) && ++o && !gn.call(t, n) || !(n in t) || !jt(e[n], t[n])) return !1;
      return Object.keys(t).length === o;
    }
  }
  return e !== e && t !== t;
}
const fs = 12, ds = (e, t) => e.polygons.reduce((n, o, i) => {
    ...
    p(r, l) {
      ...
      268491048) {
        ...
        for (a = 0; a < o.length; a += 1) {
          const u = _n(r, o, a);
          i[a] ? (i[a].p(u, l), U(i[a], 1)) : (i[a] = bn(u), i[a].c(), U(i[a], 1), i[a].m(t.parentNode, t));
        }
...
function vn(e) {
  ...
  return {
    ...
    m(T, B) {
      R(T, t, B), j(t, n), j(n, o), j(o, i), j(o, u), S && S.m(o, null), y && y.m(n, null), j(t, f), j(t, p);
    ...
    p(T, B) {
      if (e = T, (!g || B[0] & /*mask*/
      512 && s !== (s = /*mask*/
      e[9].x)) && c(i, "x", s), (!g || B[0] & /*mask*/
      512 && r !== (r = /*mask*/
      e[9].y)) && c(i, "y", r), (!g || B[0] & /*mask*/
      512 && l !== (l = /*mask*/
      e[9].w)) && c(i, "width", l), (!g || B[0] & /*mask*/
      512 && a !== (a = /*mask*/
      e[9].h)) && c(i, "height", a), (!g || B[0] & /*geom*/
      32 && d !== (d = Te(
        /*element*/
        e[30]
      ))) && c(u, "d", d), /*visibleMidpoint*/
      e[6] !== void 0 && !/*isHandleHovered*/
      e[7] ? S ? S.p(Dt(e), B) : (S = yn(Dt(e)), S.c(), S.m(o, null)) : S && (S.d(1), S = null), /*visibleMidpoint*/
      e[6] !== void 0 && !/*isHandleHovered*/
      e[7] ? y ? y.p(Ot(e), B) : (y = wn(Ot(e)), y.c(), y.m(n, null)) : y && (y.d(1), y = null), (!g || B[0] & /*geom*/
      32 && h !== (h = Te(
        /*element*/
        e[30]
      ))) && c(f, "d", h), (!g || B[0] & /*computedStyle*/
      2) && c(
        p,
        "style",
        /*computedStyle*/
      ...
      32 && m !== (m = Te(
        /*element*/
        e[30]
      ))) && c(p, "d", m), B[0] & /*geom, viewportScale, selectedCorners, onEnterHandle, onLeaveHandle, onHandlePointerDown, grab, onHandlePointerUp*/
      268491048) {
        A = ve(
          /*element*/
          e[30].rings
        ...
        for (N = 0; N < A.length; N += 1) {
          const q = pn(e, A, N);
          M[N] ? (M[N].p(q, B), U(M[N], 1)) : (M[N] = En(q), M[N].c(), U(M[N], 1), M[N].m(t, null));
        }
        for (we(), N = A.length; N < M.length; N += 1)
          C(N);
        be();
      }
    },
    ...
    d(T) {
      T && D(t), S && S.d(), y && y.d(), Re(M, T), k = !1, Se(E);
    }
  };
}
function Sn(e) {
    ...
    p(a, u) {
      ...
      268763114) {
        ...
        for (d = 0; d < i.length; d += 1) {
          const f = mn(a, i, d);
          s[d] ? (s[d].p(f, u), U(s[d], 1)) : (s[d] = vn(f), s[d].c(), U(s[d], 1), s[d].m(t.parentNode, t));
        }
      ...
      192 && U(l, 1)) : (l = Sn(Ct(a)), l.c(), U(l, 1), l.m(n.parentNode, n)) : l && (we(), H(l, 1, 1, () => {
        l = null;
      }), be());
    },
    i(a) {
...
const ms = 250, ps = 1e3, et = 4.5;
function _s(e, t, n) {
  let o, i, s;
  const r = Oe();
  let { shape: l } = t, { computedStyle: a } = t, { transform: u } = t, { viewportScale: d = 1 } = t, { svgEl: f } = t, h, p = !1, m, g = [];
  const k = () => n(7, p = !0), E = () => n(7, p = !1), S = (b) => {
    if (g.length > 0 || !i.some((J) => J.visible)) {
      n(6, h = void 0);
      return;
    }
    const [I, L] = u.elementToImage(b.offsetX, b.offsetY), O = (J) => Math.pow(J[0] - I, 2) + Math.pow(J[1] - L, 2), G = No(o).reduce((J, te) => O(te) < O(J) ? te : J), X = i.filter((J) => J.visible).reduce((J, te) => O(te.point) < O(J.point) ? te : J), Z = Math.pow(ps / d, 2);
    ...
    n(7, p = !0), b.preventDefault(), b.stopPropagation(), m = performance.now();
  }, C = (b, I, L) => (O) => {
    if (!m || Le || performance.now() - m > ms) return;
  ...
  return e.$$set = (b) => {
    ...
    e.$$.dirty[0] & /*shape*/
    1 && n(5, o = l.geometry), e.$$.dirty[0] & /*geom, viewportScale*/
    40 && n(10, i = Le ? [] : ds(o, d)), e.$$.dirty[0] & /*geom, viewportScale*/
...
const ao = /* @__PURE__ */ new Map([
  ...
  [x.POLYGON, rs],
  [x.MULTIPOLYGON, ys]
]), ws = (e) => ao.get(e.type), bs = (e, t) => ao.set(e, t);
function Es(e, t, n) {
  let o;
  const i = Oe();
...
function An(e) {
  ...
  return {
    ...
    m(f, h) {
      R(f, t, h), j(t, n), j(n, o), j(n, a), R(f, u, h), R(f, d, h);
    },
    p(f, h) {
      h & /*x, buffer*/
      34 && i !== (i = /*x*/
...
function kn(e) {
  ...
  return {
    ...
    m(k, E) {
      R(k, t, E), j(t, n), j(n, o), j(n, a), R(k, d, E), R(k, h, E), g && g.m(k, E), R(k, m, E);
    },
    p(k, E) {
      E & /*mask*/
      8 && i !== (i = /*mask*/
...
function Ls(e) {
  ...
  return {
    ...
    p(o, [i]) {
      /*mask*/
      o[3] ? n ? n.p(Rt(o), i) : (n = kn(Rt(o)), n.c(), n.m(t, null)) : n && (n.d(1), n = null);
    },
    i: ee,
    o: ee,
    d(o) {
...
function Cs(e, t, n) {
  let o, i, s;
  const r = Oe();
  let { addEventListener: l } = t, { drawingMode: a } = t, { transform: u } = t, { viewportScale: d = 1 } = t, f, h = [], p, m, g = !1;
  const k = (C) => {
    const T = C, { timeStamp: B, offsetX: N, offsetY: q } = T;
    if (f = { timeStamp: B, offsetX: N, offsetY: q }, a === "drag" && h.length === 0) {
    ...
    if (m && clearTimeout(m), a === "click") {
      const B = T.timeStamp - f.timeStamp, N = ut([f.offsetX, f.offsetY], [T.offsetX, T.offsetY]);
      if (B > 300 || N > 15) return;
      if (g)
        A();
      else if (h.length === 0) {
  ...
  Ne(() => {
    l("pointerdown", k, !0), l("pointermove", E), l("pointerup", S, !0), l("dblclick", y, !0);
  });
...
const Kt = /* @__PURE__ */ new Map([
  ["rectangle", { tool: Ts }],
  ["polygon", { tool: Os }]
]), co = () => [...Kt.keys()], uo = (e) => Kt.get(e), Ds = (e, t, n = {}) => Kt.set(e, { tool: t, opts: n });
function Rs(e) {
  let t, n, o, i, s;
  return {
    c() {
...
class Ys extends pe {
  constructor(t) {
    super(), me(this, t, Ns, Rs, se, { annotation: 0, geom: 6, style: 7 });
  }
}
function Us(e) {
  let t, n, o, i, s;
...
class Vs extends pe {
  constructor(t) {
    super(), me(this, t, Bs, Us, se, { annotation: 0, geom: 6, style: 7 });
  }
}
function Tn(e, t, n) {
  const o = e.slice();
...
class Gs extends pe {
  constructor(t) {
    super(), me(this, t, Hs, Xs, se, { annotation: 0, geom: 3, style: 4 });
  }
}
function js(e) {
  let t, n, o, i, s;
...
class Ks extends pe {
  constructor(t) {
    super(), me(this, t, qs, js, se, { annotation: 0, geom: 3, style: 4 });
  }
}
function Ws(e) {
  let t, n, o, i, s, r, l;
...
class Js extends pe {
  constructor(t) {
    super(), me(this, t, Zs, Ws, se, { annotation: 0, geom: 4, style: 5 });
  }
}
function Qs(e) {
  let t, n, o, i, s;
...
class $s extends pe {
  constructor(t) {
    super(), me(this, t, xs, Qs, se, { annotation: 0, geom: 6, style: 7 });
  }
}
const Yr = {
...
function Cn(e) {
  ...
  return {
    ...
    p(s, r) {
      ...
      s[42]) ? (we(), H(i, 1, 1, ee), be(), i = On(s), i.c(), U(i, 1), i.m(n.parentNode, n)) : i.p(s, r);
    },
    i(s) {
      o || (U(i), o = !0);
    },
...
function On(e) {
  ...
  return ~(t = l(e)) && (n = r[t] = s[t](e)), {
    ...
    m(a, u) {
      ~t && r[t].m(a, u), R(a, o, u), i = !0;
    },
    p(a, u) {
      let d = t;
      t = l(a), t === d ? ~t && r[t].p(a, u) : (n && (we(), H(r[d], 1, 1, () => {
        r[d] = null;
      }), be()), ~t ? (n = r[t], n ? n.p(a, u) : (n = r[t] = s[t](a), n.c()), U(n, 1), n.m(o.parentNode, o)) : n = null);
    },
    i(a) {
      i || (U(n), i = !0);
    },
  ...
  return {
    ...
    p(s, r) {
      ...
      s[10](
        /*annotation*/
        s[42]
      )), t ? i ? (i.p(Nt(s), r), r[0] & /*$store, isEditable*/
      132096 && U(i, 1)) : (i = Cn(Nt(s)), i.c(), U(i, 1), i.m(n.parentNode, n)) : i && (we(), H(i, 1, 1, () => {
        i = null;
      }), be());
    },
    i(s) {
...
function cr(e) {
  ...
  return {
    ...
    p(s, r) {
      ...
      132 && se(t, t = `${/*toolName*/
      s[2]}-${/*toolMountKey*/
      s[7]}`) ? (we(), H(i, 1, 1, ee), be(), i = Nn(s), i.c(), U(i, 1), i.m(n.parentNode, n)) : i.p(s, r);
    },
    i(s) {
      o || (U(i), o = !0);
    },
  ...
  return {
    ...
    p(r, l) {
      ...
      8659266) {
        ...
        for (a = 0; a < o.length; a += 1) {
          const u = Pn(r, o, a);
          i[a] ? (i[a].p(u, l), U(i[a], 1)) : (i[a] = Un(u), i[a].c(), U(i[a], 1), i[a].m(t.parentNode, t));
        }
        for (we(), a = o.length; a < i.length; a += 1)
          s(a);
        be();
...
function Un(e) {
  ...
  return {
    ...
    p(s, r) {
      r[0] & /*editors*/
      64 && se(t, t = /*editable*/
      s[39].annotation.id) ? (we(), H(i, 1, 1, ee), be(), i = Yn(s), i.c(), U(i, 1), i.m(n.parentNode, n)) : i.p(s, r);
    },
    i(s) {
      o || (U(i), o = !0);
    },
  ...
  return {
    ...
    m(f, h) {
      ...
      for (let p = 0; p < a.length; p += 1)
        a[p] && a[p].m(n, null);
      j(t, o), d && d.m(o, null), e[35](o), e[36](t), i = !0, s || (r = [
    ...
    p(f, h) {
      ...
      132098) {
        ...
        for (p = 0; p < l.length; p += 1) {
          const m = In(e, l, p);
          a[p] ? (a[p].p(m, h), U(a[p], 1)) : (a[p] = Dn(m), a[p].c(), U(a[p], 1), a[p].m(n, null));
        }
      ...
      256 && U(d, 1)) : (d = Rn(e), d.c(), U(d, 1), d.m(o, null)) : d && (we(), H(d, 1, 1, () => {
        d = null;
      }), be()), (!i || h[0] & /*tool*/
      32768) && Me(
        t,
    ...
    d(f) {
      f && D(t), Re(a, f), d && d.d(), e[35](null), e[36](null), s = !1, Se(r);
    }
  };
}
function dr(e, t, n) {
  ...
  e.$$.on_destroy.push(() => g());
  let { drawingEnabled: E } = t, { image: S } = t, { preferredDrawingMode: y } = t, { state: A } = t, { style: M = void 0 } = t, { toolName: C = co()[0] } = t, { user: T } = t, { visible: B = !0 } = t, N = 0;
  const q = () => n(7, N += 1), z = () => C, w = () => E;
  let v, _, b;
  Ne(() => k(n(9, b = Gi(S, _))));
  ...
  const Z = (V) => {
    ...
    var Ue;
    const { target: $ } = V, fe = 10 * 60 * 1e3, _e = ((Ue = $.creator) == null ? void 0 : Ue.id) !== T.id || !$.created || (/* @__PURE__ */ new Date()).getTime() - $.created.getTime() > fe;
    O.updateTarget({
      ...$,
      selector: ce.detail,
  ...
  return e.$$set = (V) => {
    "drawingEnabled" in V && n(0, E = V.drawingEnabled), "image" in V && n(25, S = V.image), "preferredDrawingMode" in V && n(26, y = V.preferredDrawingMode), "state" in V && n(27, A = V.state), "style" in V && n(1, M = V.style), "toolName" in V && n(2, C = V.toolName), "user" in V && n(28, T = V.user), "visible" in V && n(3, B = V.visible);
  }, e.$$.update = () => {
    e.$$.dirty[0] & /*toolName*/
    ...
    16 && n(13, r = er(_)), e.$$.dirty[0] & /*svgEl*/
    16 && n(12, { onPointerDown: l, onPointerUp: a } = nr(_, O), l, (n(11, a), n(4, _))), e.$$.dirty[1] & /*$selection*/
    4 && Z(h.selected), e.$$.dirty[0] & /*editableAnnotations*/
    32 && n(6, u = X ? X.map((V) => ({
      annotation: V,
      editor: ws(V.target.selector)
...
function ho(e, t, n = 0, o = e.length - 1, i = gr) {
  for (; o > n; ) {
    if (o - n > 600) {
...
class mr {
  ...
  search(t) {
    ...
    for (; n; ) {
      for (let r = 0; r < n.children.length; r++) {
        ...
        at(t, a) && (n.leaf ? o.push(l) : Ut(t, a) ? this._all(l, o) : s.push(l));
      }
      n = s.pop();
    }
    return o;
  ...
  remove(t, n) {
    ...
    for (; o || s.length; ) {
      if (o || (o = s.pop(), a = s[s.length - 1], l = r.pop(), u = !0), o.leaf) {
        const d = pr(t, o.children, n);
        if (d !== -1)
          return o.children.splice(d, 1), s.push(o), this._condense(s), this;
      }
      !u && !o.leaf && Ut(o, i) ? (s.push(o), r.push(l), l = 0, a = o, o = o.children[0]) : a ? (l++, o = a.children[l], u = !1) : o = null;
    }
    return this;
  }
  toBBox(t) {
  ...
  _build(t, n, o, i) {
    ...
    i || (i = Math.ceil(Math.log(s) / Math.log(r)), r = Math.ceil(s / Math.pow(r, i - 1))), l = je([]), l.leaf = !1, l.height = i;
    const a = Math.ceil(s / r), u = a * Math.ceil(Math.sqrt(r));
    Bn(t, n, o, u, this.compareMinX);
    for (let d = n; d <= o; d += u) {
      const f = Math.min(d + u - 1, o);
      Bn(t, d, f, a, this.compareMinY);
      for (let h = d; h <= f; h += a) {
  ...
  _chooseSubtree(t, n, o, i) {
    for (; i.push(n), !(n.leaf || i.length - 1 === o); ) {
      ...
      for (let a = 0; a < n.children.length; a++) {
        const u = n.children[a], d = Yt(u), f = wr(t, u) - d;
  ...
  _splitRoot(t, n) {
    this.data = je([t, n]), this.data.height = t.height + 1, this.data.leaf = !1, He(this.data, this.toBBox);
  }
  _chooseSplitIndex(t, n, o) {
    let i, s = 1 / 0, r = 1 / 0;
    for (let l = n; l <= o - n; l++) {
      const a = Ze(t, 0, l, this.toBBox), u = Ze(t, l, o, this.toBBox), d = br(a, u), f = Yt(a) + Yt(u);
  ...
  _chooseSplitAxis(t, n, o) {
    const i = t.leaf ? this.compareMinX : _r, s = t.leaf ? this.compareMinY : yr, r = this._allDistMargin(t, n, o, i), l = this._allDistMargin(t, n, o, s);
...
const Er = () => {
  const e = new mr(), t = /* @__PURE__ */ new Map(), n = () => [...t.values()], o = () => {
    e.clear(), t.clear();
  }, i = (f) => {
    if (!dt(f)) return;
  ...
  const t = wi(), n = Er(), o = ri(t, e.userSelectAction, e.adapter), i = si(t), s = Ai();
  ...
  const t = Ar(e), n = t > 0.6 ? "dark" : "light";
  return console.log(`[Annotorious] Image brightness: ${t.toFixed(1)}. Setting ${n} theme.`), n;
}, Vn = (e, t, n) => t.setAttribute("data-theme", n === "auto" ? kr(e) : n), Mr = (e, t) => ({
  ...e,
...
}), Xn = typeof navigator > "u" ? !1 : navigator.userAgent.indexOf("Mac OS X") !== -1, Tr = (e, t) => {
  ...
  const n = typeof e == "string" ? document.getElementById(e) : e, o = Mr(t, {
    drawingEnabled: !0,
    drawingMode: "drag",
    userSelectAction: oo.EDIT,
    theme: "light"
  }), i = Sr(o), { selection: s, store: r } = i, l = Si(r, o.initialHistory), a = ki(
    i,
    l,
    o.adapter,
    o.autoSave
  ...
  const p = Ti(i, l, o.adapter), m = () => h.cancelDrawing(), g = () => {
    h.$destroy(), u.parentNode.insertBefore(n, u), u.parentNode.removeChild(u), d.destroy(), l.destroy();
  }, k = () => h.getDrawingTool(), E = () => f, S = () => h.isDrawingEnabled(), y = (w, v, _) => Ds(w, v, _), A = (w, v) => bs(w, v), M = (w) => {
    if (!uo(w))
      throw `No drawing tool named ${w}`;
    h.$set({ toolName: w });
  }, C = (w) => h.$set({ drawingEnabled: w }), T = (w) => {
    console.warn("Filter not implemented yet");
  }, B = (w) => h.$set({ style: w }), N = (w) => Vn(n, u, w), q = (w) => {
    f = w, h.$set({ user: w });
  }, z = (w) => (
    // @ts-ignore
    h.$set({ visible: w })
...
export {
  ...
  vs as EditorMount,
  Fe as Handle,
  Yr as IdentityTransform,
  lo as MidpointHandle,
  rs as PolygonEditor,
  us as RectangleEditor,
  Vo as RectangleUtil,
  Ts as RubberbandRectangle,
  hr as SVGAnnotationLayer,
  x as ShapeType,
  As as ToolMount,
  oo as UserSelectAction,
  Nr as W3CImageFormat,
  nr as addEventListeners,
  ...
  Or as computeStyle,
  Cr as createBody,
  Ur as createImageAnnotator,
  vr as createImageAnnotatorState,
  er as createSVGTransform,
  Sr as createSvelteImageAnnotatorState,
  ...
  Bi as parseW3CImageAnnotation,
  Co as pointsToPath,
  bs as registerEditor,
  Ke as registerShapeUtil,
  Ds as registerTool,
  Ar as sampleBrightness,
  Ho as serializeFragmentSelector,
  $o as serializeSVGSelector,
  Vi as serializeW3CImageAnnotation,
  Vn as setTheme,
  Pr as simplifyMultiPolygon,
  Qn as simplifyPoints,
  Ir as simplifyPolygon
};

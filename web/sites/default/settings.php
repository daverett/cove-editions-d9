 ...
 * @endcode
 */
$settings['hash_salt'] = 'fR2qHWRUDMECRjgVHoUDWgp3c1RlnRmUQKSTHuqceXN6xAEYVFnN14ftGDrnY4RN4lEWflsmwH';
...
/**
 * Lando-specific overrides for local development.
 */
if (getenv('LANDO') == 'ON') {
...
elseif (file_exists($app_root . '/' . $site_path . '/settings.platformsh.php')) {
